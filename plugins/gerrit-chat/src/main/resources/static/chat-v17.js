Gerrit.install(plugin => {
  ...
  class GerritChatWidget extends HTMLElement {
    ...
    render() {
      this.shadowRoot.innerHTML = `
        <style>
          ...
          .role-account gr-account-label {
            --account-max-length: 200px;
            color: #374151;
          }

          .role-account gr-account-label::part(gr-account-label-text) {
            font-size: 11px;
            color: #374151;
          }
    ...
    renderAuthorBadge(msg, roleName) {
      ...
      if (roleName === 'user' && accountId) {
        ...
        avatar.src = getAuthorAvatarUrl(msg, accountId, authorName);
        ...
        accountLabel.hideAvatar = true;
        accountLabel.clickable = false;
  ...
  function fallbackSeedEmail(accountId, authorName) {
    const byId = {
      ...
      1000001: 'alice@example.com',
      1000002: 'bob@example.com',
      1000003: 'carol@example.com',
    };
